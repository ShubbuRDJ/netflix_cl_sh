...
import { createMovies } from "../../context/movieContext/movie_API_call";
    ...
    <div className="newProduct">
      ...
      <form className="addProductForm">
        ...
        <div className="addProductItem">
          ...
          <input type="text" placeholder="Enter description here" name="desc" onChange={handleOhChange}  />
        </div>
        <div className="addProductItem">
          <label>Year</label>
          <input type="text" placeholder="Enter year here" name="year" onChange={handleOhChange} />
        </div>
        <div className="addProductItem">
          <label>Genre</label>
        ...
        <div className="addProductItem">
          ...
          <input type="text" placeholder="Enter duration here" name="duration" onChange={handleOhChange}  />
        </div>
        <div className="addProductItem">
          <label>Limit</label>
          <input type="text" placeholder="Enter limit here" name="limit" onChange={handleOhChange}  />
        </div>
        <div className="addProductItem">
          <label>Is Series?</label>
          <select name="isSeries" id="isSeries" onChange={handleOhChange}>
